...
public class RabbitProduce {
    ...
    public void send() {
        ...
        rabbitTemplate.send(StringConstants.QUEUE_NAME, new Message(message.getBytes(StandardCharsets.UTF_8), props));
    ...
    public void convertAndSend() {
        ...
        rabbitTemplate.convertAndSend(StringConstants.QUEUE_NAME, user);
        System.out.println("消息发送完毕。");
    }
    ...
    public void sendObject() {
        ...
        rabbitTemplate.convertAndSend(StringConstants.JSON_QUEUE, client);
        System.out.println("消息发送完毕。");
    }
    ...
    public void sendAndConfirm() {
        ...
        rabbitTemplate.convertAndSend(StringConstants.QUEUE_NAME, user, correlationData);
        log.info("消息发送完毕。");
