...
public class EmailUtil {
    ...
    public static void main(String[] args) throws Exception {
        sendEmail01("test@163.com","复杂邮件","自定义图片：<img src='cid:gzh.jpg'/>,网络图片：<img src='http://pic37.nipic.com/20140113/8800276_184927469000_2.png'/>") ;
    }
    ...
    private static MimeMessage createEmail02 (Session session,String receiver,String title,String body)
        ...
        image.setDataHandler(new DataHandler(new FileDataSource("email-send/src/xxx.jpg")));
        image.setContentID("xxx.jpg");
        //附件内容
        MimeBodyPart attach = new MimeBodyPart();
        DataHandler file = new DataHandler(new FileDataSource("email-send/src/xxx.zip"));
