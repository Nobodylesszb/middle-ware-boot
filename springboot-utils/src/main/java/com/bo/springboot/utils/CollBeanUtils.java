...
public class CollBeanUtils extends BeanUtils {
     ...
     */
    public static <S, T> List<T> copyListProperties(List<S> sources, Supplier<T> target, CollBeanUtilsCallBack<S, T> callBack) {
